...
export const P = {
  ...
  corner: {
    ...
    planPremium: "Premium access is active",
    planFree: "Free bedtime prayers",
    planPreview: "Preview mode · no real subscription",
    planUnknown: "We couldn’t check your plan. Please try again when connected.",
    retry: "Check again",
    restoreSuccess: "Your purchases have been restored.",
    reminderUnavailable: "Reminders couldn’t be enabled. Check that notifications are allowed for CapyPray in your device settings. Reminders require an installed mobile build.",
    reminderError: "We couldn’t update your reminder. Please try again. Your previous time has been kept.",
    settings: "Open device settings",
    earlier: "Earlier bedtime",
    later: "Later bedtime",
    localData: "Progress is saved on this device only. Deleting the app or changing phones may remove it. Restoring purchases restores paid access, not your child’s progress.",
    about: "About CapyPray",
    version: (version: string) => `Version ${version}`,
    deleteError: "We couldn’t complete the reset. Please try again.",
    child: "Child",
    bedtime: "Bedtime",
    ...
    deleteConfirm: "This erases the profile, progress, prayer people and streak on this device. It does not cancel a store subscription. Continue?",
    deleted: "Deleted.",
    privacy: "CapyPray does not record voices or collect photos, location or contacts. Your child’s profile, prayer people and progress stay on this device in this release. Subscription purchases are processed by your store and RevenueCat.",
  ...
  paywall: {
    ...
    storeCTA: "Continue with this plan",
    storeAnnualNote: "One payment each year",
    storeUnavailable: "Plans are unavailable right now. Free prayers are still available.",
    storeBilling: (price: string, period: string) => `${price} ${period} · auto-renews until canceled`,
    storeTerms: "Payment is charged to your store account when you confirm. Subscriptions renew automatically unless canceled before renewal. Manage or cancel in your App Store or Google Play account. Any eligible trial and its duration are shown by the store before you confirm.",
    ...
    restoreEmpty: "No active subscription was found for this store account.",
