...
export const P = {
  ...
  paywall: {
    ...
    restoreEmpty: "We didn’t find an active subscription for this account.",
    ...
    ctaSubLive: (price: string, per: string) => `then ${price}/${per} · cancel any time`,
    annualNoteLive: (perMonth: string) => `${perMonth}/month, billed yearly`,
    yearWord: "year",
    monthWord: "month",
    autoRenew: "Payment is charged to your Apple ID or Google Play account when the free trial ends. The subscription renews automatically unless cancelled at least 24 hours before the end of the current period. Manage or cancel any time in your account settings.",
    terms: "Terms of Use",
